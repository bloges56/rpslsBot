...
import static java.lang.Math.max;
  ...
  public class FlipBot implements RoShamBot {
    ...
    public Action getNextMove(Action lastOpponentMove) {
        ...
        if (OpponentStr.length() > 1){
            ...
            int [] scores = new int [] {MHScore, FAScore_V, counterFAScore_V, doubleCounterFAScore_V, FAScore_X, counterFAScore_X, doubleCounterFAScore_X, CounterMHScore, CApeScore, NashScore}; //
            String [] strategies = new String [] {MHStr, FAStr_V, counterFAStr_V, doubleCounterFAStr_V, FAStr_X, counterFAStr_X, doubleCounterFAStr_X, CounterMHStr, CApeStr, NashStr}; //
